...
class LLMMessenger(APIHandler):
    ...
    def send_request(request):
        ...
        # response = requests.post(url=LLMMessenger.API_endpoint(), json=request, headers=HEADERS)
         ...
         # Put the location of to the GGUF model that you've download from HuggingFace here (https://huggingface.co/TheBloke/Llama-2-13B-chat-GGUF/resolve/main/llama-2-13b-chat.Q2_K.gguf?download=true)
